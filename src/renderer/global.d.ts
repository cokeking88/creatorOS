import type { AppState, BrowserSnapshot, LogEntry, LogFilter, AgentEngineConfig, AgentStep, AgentRunResult, AgentRunsOverview, SkillRecord } from '../shared/types';
declare global { interface Window { creatorOS: {
  ...
  skills:{create:(x:{name:string;description?:string;promptTemplate:string})=>Promise<SkillRecord>;update:(id:string,x:Partial<SkillRecord>)=>Promise<SkillRecord|null>;delete:(id:string)=>Promise<void>};
